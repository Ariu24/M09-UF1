...
public class aes {
    ...
    private static final String CLAU = "yagito";
    ...
    private static SecretKeySpec crearClau(String clau) throws Exception {
    ...
    private static byte[] cifrar(byte[] bytes, SecretKeySpec keySpec, IvParameterSpec ivParams) throws Exception {
        Cipher cipher = Cipher.getInstance(FORMAT_AES);
        cipher.init(Cipher.ENCRYPT_MODE, keySpec, ivParams);
        return cipher.doFinal(bytes);
    }
    
    private static byte[] combinarIVyCifrado(byte[] iv, byte[] encrypted) {
